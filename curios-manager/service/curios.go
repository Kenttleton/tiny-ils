...
func NewCuriosService(c *store.CurioStore, l *store.LoanStore, ls *store.LeaseStore, t *store.TransferStore, lcpClient *lcp.Client) *CuriosService {
	return &CuriosService{curios: c, loans: l, leases: ls, transfers: t, lcp: lcpClient}
}
